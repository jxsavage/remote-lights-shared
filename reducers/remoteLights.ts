...
const removeMicrosReducer:
StateReducer<RemoveMicrosPayload> = (state, { microIds }): RemoteLightsState => {
...
const remoteLights:
StateReducers<StateActions> = (state = initialState, action): RemoteLightsState => {
